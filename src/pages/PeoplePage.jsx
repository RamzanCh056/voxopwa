    ...
    <div className="flex flex-col min-h-screen bg-[#F0F2F7] dark:bg-[#0F0C29] transition-colors duration-300">
      ...
      <div className="px-5 pt-12 pb-5 md:hidden bg-white dark:bg-[#1E1B4B] border-b border-gray-100 dark:border-transparent"
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-bold text-gray-800 dark:text-white">Relationships</h1>
          <button className="w-8 h-8 rounded-full flex items-center justify-center font-bold text-gray-600 dark:text-white text-lg bg-gray-100 dark:bg-white/15"
      ...
      <div className="hidden md:flex items-center justify-between bg-white dark:bg-[#1A1740] border-b border-gray-200 dark:border-[#2E2B5B] px-8 py-4 sticky top-0 z-10">
        <h1 className="text-xl font-bold text-gray-800">Relationships</h1>
      ...
      <div className="flex-1 px-4 pt-5 pb-24 md:pb-8 md:px-8 flex flex-col gap-4 md:max-w-5xl md:w-full md:mx-auto">
        ...
        {/* ── Info card ── */}
        <div className="bg-white rounded-2xl shadow-sm p-5 flex flex-col items-center gap-3 text-center md:flex-row md:text-left md:gap-5">
          ...
          <div className="flex-1">
            <p className="font-bold text-gray-800 text-sm">Track relationships</p>
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 py-10">
          <svg viewBox="0 0 120 100" className="w-32 h-28" fill="none">
            ...
            <path d="M42 54c9 6 27 6 36 0" stroke="#D1D5DB" strokeWidth="2.5"

      ...
      <div className="w-full max-w-sm relative" style={{ animation: 'fade-up 0.6s ease both' }}>
        ...
        <div className="rounded-2xl p-6" style={{ ...cardStyle, animation: 'fade-up 0.55s ease both 0.15s' }}>
          ...
          <button type="button" onClick={handleGoogle} disabled={googleLoading}
            className="w-full py-3 rounded-xl text-sm font-semibold flex items-center justify-center gap-3 transition-all mb-3"
            style={{
            ...
            {googleLoading ? (
              <svg className="animate-spin w-5 h-5" viewBox="0 0 24 24" fill="none">
                <circle cx="12" cy="12" r="10" stroke="#9CA3AF" strokeWidth="4"/>
                <path fill="#6C63FF" d="M4 12a8 8 0 0 1 8-8v4a4 4 0 0 0-4 4H4z"/>
              </svg>
            ) : (
